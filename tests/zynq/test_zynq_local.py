...
from paiboard.zynq import ZynqLocal  # noqa: E402


class TestZynqLocal:
    def test_read_write_regfile(self, zynq_local_instance: ZynqLocal):
    ...
    def test_config_uart_chip(self, zynq_local_instance: ZynqLocal, clk_freq):
        zynq = zynq_local_instance
    ...
    def test_send_frames_cfg(self, zynq_local_instance: ZynqLocal, toolchain_build_dir):
        zynq = zynq_local_instance

        test_name = "test_001_Conv1d"  # Target is (0,0), output to (2,0)
